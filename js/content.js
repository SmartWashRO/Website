...
window.SmartWash.CONTENT = {
  en: {
    nav: { home: 'Home', about: 'How it works', pricing: 'Pricing', locations: 'Locations', business: 'For Business', contact: 'Contact', call: 'Call now' },
    ...
    home: {
      ...
      title: 'Clean car.\nSmart choice.',
      subtitle: 'Park at any of our sites, and we\u2019ll hand-wash your car while you shop, work, or relax.\nNo booking, no waiting in line, no lifting a finger.',
      ...
      ctaTitle: 'Ready for a spotless car, without lifting a finger?', ctaSub: 'Just park at any of our sites.', ctaLocations: 'Locations',
    },
    ...
    about: {
      ...
      comparison: [
        { t: 'Better than Full-Service / Tunnel Wash', d: 'No queue, no driving there, and no rotating brushes that can carry grit from car to car and leave fine swirl marks. We come to you instead.' },
        { t: 'Better than Self-Service Bays', d: 'No standing outside with a wand in the cold or rain, no pay-by-the-minute pressure, and no arm-stretching for an SUV roof. We do the work by hand.' },
        { t: 'Better than Doing It Yourself', d: 'No hose, no bucket, no hour of your weekend gone — and a more consistent, professional finish every time.' },
      ],

      ctaTitle: 'Ready to see it for yourself?', ctaSub: 'Visit one of our sites.',
    },
  ...
  ro: {
    ...
    home: {
      ...
      title: 'Mașină curată,\nfără griji.',
      subtitle:
        'Parchezi la una dintre locațiile noastre și îți spălăm mașina manual cât timp faci cumpărături, lucrezi sau te relaxezi.\nFără programare, fără coadă, fără bătaie de cap.',
      ctaCall: 'Sună acum',
      ...
      ctaSub: 'Parchezi direct la una dintre locațiile noastre.',
      ctaLocations: 'Locații'
    },
...
window.SmartWash.CONTACT = { phone: '+40 755 282 775', phoneTel: 'tel:+40755282775', whatsapp: 'https://wa.me/40755282775', email: 'contact@smartwashromania.com' };
