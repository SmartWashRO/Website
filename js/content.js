...
window.SmartWash.CONTENT = {
  ...
  ro: {
    ...
    home: {
      ...
      stats: [ { value: '99,3%', label: 'mai puțină apă' }, { value: '30-45 min', label: 'durata medie' }, { value: '0', label: 'drumuri la spălătorie' } ],
    ...
    business: {
      ...
      stats: [ { value: '99,3%', label: 'mai puțină apă' }, { value: '0 lei', label: 'cost de găzduire' }, { value: 'Zero', label: 'infrastructură necesară' } ],
      ...
      hostBenefits: [
        ...
        { t: 'Echipă asigurată complet', d: 'Colegii noștri, uniformizați și asigurați — fără nicio schimbare pentru tine.' },
      ],
      ...
      fleetBenefits: [
        ...
        { t: 'Mereu impecabile', d: 'Mașinile de reprezentanță rămân ireproșabile, după un program stabilit de tine.' },
